            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <audio id='audioSrc' className={styles.audiocontrols} controls="controls" controlsList="nodownload"><source src="https://cdn.shopify.com/s/files/1/0462/4485/5961/files/OGYBORY808_TYPE_BEAT_-_PACKZ.mp3?v=1661082512" type="audio/mpeg" />Your browser does not support the audio tag.</audio>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    ...
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(spninfo.ES.Info.Floor1Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(spninfo.ES.Info.Floor2Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(spninfo.ES.Info.Floor3Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(catinfo.ES.Info.Floor1Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(catinfo.ES.Info.Floor2Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(catinfo.ES.Info.Floor3Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(frinfo.ES.Info.Floor1Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(frinfo.ES.Info.Floor2Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(frinfo.ES.Info.Floor3Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(itinfo.ES.Info.Floor1Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(itinfo.ES.Info.Floor2Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(itinfo.ES.Info.Floor3Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
          ...
          return (
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(enginfo.ES.Info.Floor1Size) - 1) setCount(count + 1); play(); }}>NEXT</button>
                  </div>
                </div>
              </div>
          )
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(enginfo.ES.Info.Floor2Size) - 1) setCount(count + 1); play() }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
            ...
            <>
              ...
              <div onLoad={() => {play()}} className={styles.container}>
                ...
                <div className={styles.main}>
                  ...
                  <div className={styles.navbuttonscontainer}>
                    <button className={styles.navbutton} onClick={() => { if (count > 0) setCount(count - 1); play() }}>PREVIOUS</button>
                    <button className={styles.navbutton} onClick={() => { if (count < parseInt(enginfo.ES.Info.Floor3Size) - 1) setCount(count + 1); play(); }}>NEXT</button>
                  </div>
                </div>
              </div>
            </>
